...
public class FastFoodKiosk {
    ...
    static void orderFood() {
        ...
        Map menuNames = new LinkedHashMap<>();
    ...
    static void addMoreItems(Map orderItems, Map menu, Map names) {
        boolean adding = true;
    ...
    static int calculateTotal(Map order, Map menu) {
        int total = 0;
    ...
    static void displayOrder(Map order, Map menu, Map names) {
        for (Map.Entry entry : order.entrySet()) {
    ...
    static void removeItem(Map order, Map names) {
        List keys = new ArrayList<>(order.keySet());
        ...
        if (choice >= 1 && choice <= keys.size()) {
            ...
            System.out.println(names.get(selectedKey) + " removed.");
        } else {
            System.out.println("Invalid choice.");
        }
    }

    static void printReceipt(Map order, Map menu, Map names) {
